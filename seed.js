...
var data = {
  ...
  product: [
    {name: 'Ruby', carat: 5, price: 50, stock: 1, description: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Ruby_logo.svg/1000px-Ruby_logo.svg.png'},
    {name: 'Gem', carat: 1, price: 100, stock: 4, description: 'A kinda really cool product', picture: 'https://gem.co/wp-content/uploads/2016/06/Logo-Vertical-square-300x300.png'},
    {name: 'Diamond', carat: 1, price: 4500, stock: 87, description: 'Diamonds are forever', picture: 'https://g.foolcdn.com/editorial/images/437660/diamond_large.jpg'},
    {name: 'Meteor', carat: 1000, price: 90000, stock: 1, picture: 'http://68.media.tumblr.com/cefc8154d1098e13fbd4f0ea5427ee2e/tumblr_n17xwwwVWf1ttwae3o1_1280.jpg',  description: 'A big meteor'},
    {name: 'Pig Iron', carat: 2, price: 500, stock: 2, description: 'A hunk of iron with pig ears', picture: 'https://pimg.tradeindia.com/02216539/b/1/Pig-Iron.jpg'},
    {name: 'Cat Iron', carat: 2, price: 200, stock: 5, description: 'A hunk of iron with cat ears', picture: 'http://artalika.com/painted_rocks/cats/rock_round-cat.jpg'},
    {name: 'Fools Iron', carat: 6, price: 100, stock: 200, description: 'Only a fool would buy this iron', picture: 'https://images-na.ssl-images-amazon.com/images/I/51OyxZq-SQL._SX200_QL80_.jpg'},
    {name: 'Gold', carat: 2, price: 10000, stock: 5, description: 'Just gold', picture: 'http://image.shutterstock.com/z/stock-photo-c-programming-d-block-letters-gold-white-background-102665846.jpg'},
    {name: 'Sapphires', carat: 16, price: 5000, stock: 15, description: 'A mediocre gem', picture: 'http://www.lotusgemology.com/images/library/articles/quality/lotus-color-types/indigo-sapphire.jpg'}
  ],
  review: [
